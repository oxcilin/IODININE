...
<head>
    ...
    <!--=============== TITLE ===============-->
    <title>
        <?php include 'admin/theme/name_page.php'?>
    </title>
...
<body>
    ...
    <div class="translations-content-container">
        <div class="container">
            <div class="tab-content translations-content-item en visible" style="text-align: justify" id="en">
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
                            Agreement) refers to IODININE, Indonesia.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to IODININE, accessible from <a
                                href="https://iodinine.oxa.biz.id/kas" rel="external nofollow noopener"
                                target="_blank">https://iodinine.oxa.biz.id/kas</a></p>
                    </li>
                    <li>
                ...
                <h2>Treasurer's Rights</h2>
                <p>The treasurer has the following rights, which may be exercised at their sole discretion</p>
                <p><strong>Modify transaction data:</strong> The treasurer may modify your transaction data in the following situations:</p>
                <ol>
                <li>To correct errors or inconsistencies;</li>
                <li>To comply with applicable laws or regulations;</li>
                <li>To protect the integrity of our services.</li>
                </ol>

                <p><strong>Change transaction status:</strong> The treasurer may change the status of your transaction, such as from "unpaid" to "paid," based on verification with the original transaction document.</p>

                <p><strong>Modify transaction information:</strong> The treasurer may modify the information associated with your transaction, such as the date, amount, or description.</p>
                ...
                <ul>
                    <i class="fa-regular fa-envelope"></i> <a href="mailto:iodinine@oxa.biz.id">iodinine@oxa.biz.id</a>
                </ul>
            </div>
        </div>
    </div>
